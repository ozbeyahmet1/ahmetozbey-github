...
export const HomepageUIData: HomepageUI = {
  ...
  selectedRepositories: ["facebook/react", "microsoft/vscode", "ozbeyahmet1/hefore", "nodejs/node"],
  popularSearchs: ["tensorflow/tensorflow", "docker/docker-ce", "pytorch/pytorch", "numpy/numpy"],
};
